...
static void DrawScreenshot3DDebugWindow(float scale)
{
  (void)scale;
...
static constexpr const std::array<DebugWindowInfo, NUM_DEBUG_WINDOWS> s_debug_window_info = {{
  ...
  {"3DScreenshot", "3D Screenshot", ":icons/applications-system.png", &DrawScreenshot3DDebugWindow, 400, 190},
...
{
#ifndef __ANDROID__
  return (s_debug_window_state[2].window_handle != nullptr);
#else
  return false;
#endif
}
